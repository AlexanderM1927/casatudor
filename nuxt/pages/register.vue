    ...
    <div class="custom-container center-container">
        ...
        <form @submit.prevent="submit" preven>
            <div class="mb-3">
                ...
                <input v-model="firstName" type="text" class="form-control" aria-describedby="emailHelp">
                <div id="emailHelp" class="form-text">Ex: Juan</div>
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Last name</label>
                <input v-model="lastName" type="text" class="form-control" aria-describedby="emailHelp">
